 ...
 * Filename:
 * ---------
 *	 mot_cybert_s5k3k1mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *============================================================================
 ****************************************************************************/
#include "mot_s5k3k1mipiraw_Sensor.h"

static void set_group_hold(void *arg, u8 en);
static u16 get_gain2reg(u32 gain);
static int mot_s5k3k1_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int mot_s5k3k1_set_test_pattern_data(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
#if ENABLE_S5K3K1_LONG_EXPOSURE
...
static struct subdrv_feature_control feature_control_list[] = {
	{SENSOR_FEATURE_SET_TEST_PATTERN, mot_s5k3k1_set_test_pattern},
	{SENSOR_FEATURE_SET_TEST_PATTERN_DATA, mot_s5k3k1_set_test_pattern_data},
#if ENABLE_S5K3K1_LONG_EXPOSURE
...
static struct subdrv_static_ctx static_ctx = {
	...
	.ana_gain_type = 2,
	.ana_gain_step = 2,
	.ana_gain_table = mot_s5k3k1_ana_gain_table,
	.ana_gain_table_size = sizeof(mot_s5k3k1_ana_gain_table),
	.min_gain_iso = 100,
	.exposure_def = 0x3D0,
	.exposure_min = 9,
...
const struct subdrv_entry mot_cybert_s5k3k1_mipi_raw_entry = {
	.name = "mot_cybert_s5k3k1_mipi_raw",
	.id = MOT_CYBERT_S5K3K1_SENSOR_ID,
	.pw_seq = pw_seq,
