...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = MOT_OULU_IMX896_SENSOR_ID,
...
const struct subdrv_entry mot_oulu_imx896_mipi_raw_entry = {
	.name = "mot_oulu_imx896_mipi_raw",
	.id = MOT_OULU_IMX896_SENSOR_ID,
	.pw_seq = pw_seq,
