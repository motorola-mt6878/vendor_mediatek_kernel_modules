 ...
 *============================================================================
 ****************************************************************************/
#include "mot_scout_gc32e1mipiraw_Sensor.h"
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = MOT_SCOUT_GC32E1_SENSOR_ID,
...
static struct subdrv_pw_seq_entry pw_seq[] = {
	...
	{HW_ID_DVDD, 1200000, 8},
	{HW_ID_AVDD, 2800000, 4},
	{HW_ID_RST, 1, 5},
};

const struct subdrv_entry mot_scout_gc32e1_mipi_raw_entry = {
	.name = "mot_scout_gc32e1_mipi_raw",
	.id = MOT_SCOUT_GC32E1_SENSOR_ID,
	.pw_seq = pw_seq,
