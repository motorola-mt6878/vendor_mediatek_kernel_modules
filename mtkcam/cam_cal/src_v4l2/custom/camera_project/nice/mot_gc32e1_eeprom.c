...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000003, 0x32384439, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x000007E7, 0x0000074C, mot_do_single_lsc},//CAMERA_CAM_CAL_DATA_SHADING_TABLE
		{0x00000001, 0x00000041, 0x0000002B, mot_do_awb_gain},//CAMERA_CAM_CAL_DATA_3A_GAIN
		{0x00000000, 0x00000000, 0x00000000, mot_do_pdaf},//CAMERA_CAM_CAL_DATA_PDAF
		{0x00000000, 0x00000000, 0x00000000, do_stereo_data},//CAMERA_CAM_CAL_DATA_STEREO_DATA
		{0x00000000, 0x00000000, GC32E1_MOT_EEPROM_DATA_SIZE, do_dump_all},//CAMERA_CAM_CAL_DATA_DUMP
		{0x00000000, 0x00000000, 0x00000000, do_lens_id},//CAMERA_CAM_CAL_DATA_LENS_ID
		{0x00000000, 0x00000000, 0x00000000, NULL},//CAMERA_CAM_CAL_DATA_SHADING_TABLE_16_9
		{0x00000001, 0x00000000, 0x00000025, mot_do_manufacture_info}//CAMERA_CAM_CAL_DATA_MANUFACTURE
	}
};
